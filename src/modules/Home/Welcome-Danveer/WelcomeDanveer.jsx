    ...
    <div className="container">
      <div className="row">
        ...
        <p className="detail-p">
          હિન્દુ ધર્મમાં ગાયો માટે ધાર્મિક મહત્વ છે. ગાયો એ આપણો સાંસ્કૃતિક
          વારસો છે તેથી અમે ગાયોના રક્ષણ માટે દરેક શક્ય પ્રયાસો કરી રહ્યા છીએ.
          જો કે, આ ઉમદા હેતુ સાથે ચાલુ રાખવા માટે અમને તમારા યોગદાન જરૂર છે. તમે
          કરેલા દરેક દાનનો ઉપયોગ ગાયોને રહેવા માટેના વાતાવરણને પ્રદાન કરવા માટે
          છે. આ તમારો વારો છે કે તમે પરિવર્તન થશો, ફાળો આપો અને આ મિશનને ચાલુ
          રાખવામાં અમારી સહાય કરો.
        </p>
      </div>
